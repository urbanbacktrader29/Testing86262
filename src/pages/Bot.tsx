    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">
          Handelt vollautomatisch anhand eines über Groq gehosteten offenen KI-Modells im Backend — einmal aktivieren, läuft danach eigenständig weiter.
        </p>
      </div>
      ...
      <div className="bg-amber-500/10 border border-amber-500/30 text-amber-200 rounded-lg px-4 py-3 text-sm leading-relaxed">
        ...
        fließt kein echtes Geld. Kurse basieren auf echten Binance-Daten, die Signale kommen von einem einzelnen,
        über Groq gehosteten offenen KI-Modell (Llama 3.1 8B), das serverseitig läuft (Begründungen können dennoch
        ungenau oder inkonsistent sein — die Kalibrierungs-Sperre unten fängt systematisch überschätzte Konfidenz
        ab). Anders als eine rein regelbasierte Version kann der Bot verpasste Zeit (Tab geschlossen) nicht
        rückwirkend simulieren — er bewertet beim nächsten Zyklus einfach live weiter.
      </div>
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-amber-500/10 border border-amber-500/30 text-amber-200 rounded-lg px-4 py-2.5 text-xs leading-relaxed">
        <span className="font-semibold">Papier-Trading (simuliert)</span> — virtuelles Kapital, Signale von einem über Groq gehosteten offenen KI-Modell (serverseitig).
      </div>
      ...
      <div className="text-[11px] text-slate-500 leading-relaxed bg-slate-900/40 border border-slate-800 rounded-xl p-4">
        Regelbasierte Risiko-Engine um ein einzelnes, über Groq gehostetes offenes KI-Modell (Llama 3.1 8B,
        serverseitig) herum, simuliert. Der Bot eröffnet automatisch eine Position, sobald ein Coin aus deiner
        ...
        LLM-Urteil nicht günstig und deterministisch für die Vergangenheit neu berechnet werden. Einzelanalysen
        können dennoch ungenau oder inkonsistent ausfallen; die Kalibrierungs-Sperre unten ist hier entsprechend
        wichtiger als bloße Dekoration. Lernen
